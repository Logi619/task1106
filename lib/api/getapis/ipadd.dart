...
class ipinf extends StatefulWidget {
  const ipinf({super.key});

  @override
  State<ipinf> createState() => _ipinfState();
}

class _ipinfState extends State<ipinf> {
